...
if (isset($_POST['update'])) {
  ...
  header('Location: base_secre.php');
}
...
<form action="edit_secre.php?id=<?php echo $_GET['id']; ?>" method="POST">
...
<div class="form-row">
    <div class="form-group col-md-2.5">
      ...
      <select class="form-control" name="examen">
        ...
        <option value="Con_Medicos">Con Examen</option>
        <option value="Sin_Medicos">Sin Examen</option>
      </select>
    </div>
    <div class="form-group col-md-2.5">
